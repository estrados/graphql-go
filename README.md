# graphql-go [![Sourcegraph](https://sourcegraph.com/github.com/estrados/graphql-go/-/badge.svg)](https://sourcegraph.com/github.com/estrados/graphql-go?badge) [![Build Status](https://semaphoreci.com/api/v1/graph-gophers/graphql-go/branches/master/badge.svg)](https://semaphoreci.com/graph-gophers/graphql-go) [![GoDoc](https://godoc.org/github.com/estrados/graphql-go?status.svg)](https://godoc.org/github.com/estrados/graphql-go)
...
We're trying out the GitHub Project feature to manage `graphql-go`'s [development roadmap](https://github.com/estrados/graphql-go/projects/1).
...
import (
        ...
        graphql "github.com/estrados/graphql-go"
        "github.com/estrados/graphql-go/relay"
)
